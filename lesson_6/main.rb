...
# 2. Для класса маршрута сделать валидацию, что при добавлении станций
# объекты имеют тип RailwayStation.
# 3. Добавить валидацию на глобальную уникальность номера поезда.
