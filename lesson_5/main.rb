...
# 3. В классе Train создать метод класса find, который принимает
# номер поезда и возвращает объект поезда по номеру
...
# Методы класса:
# 1. instances, который возвращает количество экземпляров данного класса
# Инстанс-методы:
# 1. register_instance, который увеличивает счетчик количества экземпляров
